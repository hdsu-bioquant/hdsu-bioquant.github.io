...
Welcome to the **CROm (Computation Regulatory Omics) Lab** (formerly at Health Data Science Unit) at the Institute of Pharmacy and Molecular Biotechnology (IPMB) and BioQuant, Universität  Heidelberg. 
...
<figure>
<img src="{{ site.url }}{{ site.baseurl }}/images/cromlab_lab_picture_todtnau.PNG" width="95%">
</figure>
